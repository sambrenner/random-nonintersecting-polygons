...
makeMorphable();
},{}],"node_modules/hull.js/src/intersect.js":[function(require,module,exports) {
...
},{}],"node_modules/hull.js/src/grid.js":[function(require,module,exports) {
...
module.exports = grid;
},{}],"node_modules/hull.js/src/format.js":[function(require,module,exports) {
module.exports = {
...
},{}],"node_modules/hull.js/src/convex.js":[function(require,module,exports) {
...
},{}],"node_modules/hull.js/src/hull.js":[function(require,module,exports) {
/*
...
},{"./intersect.js":"node_modules/hull.js/src/intersect.js","./grid.js":"node_modules/hull.js/src/grid.js","./format.js":"node_modules/hull.js/src/format.js","./convex.js":"node_modules/hull.js/src/convex.js"}],"node_modules/noisejs/index.js":[function(require,module,exports) {
var global = arguments[3];
/*
...
document.addEventListener('DOMContentLoaded', function () {
  draw = new SVG.Svg().addTo('#svg-holder').size(304, 304);
  output = document.querySelector('#output');
  seedOutput = document.querySelector('#seed');
  document.querySelector('#regen').addEventListener('click', function (e) {
    e.preventDefault();
    reseed();
    generatePoints();
    drawPoly();
  ...
  _toConsumableArray(document.querySelectorAll('input')).forEach(function (input) {
    input.addEventListener('input', function (e) {
      var key = e.target.dataset.controls;
      var val = e.target.type === 'checkbox' ? e.target.checked : parseFloat(e.target.value);
      config[key] = val;
...
var generatePoints = function generatePoints() {
  ...
  for (var x = 0; x < 100; x++) {
    for (var y = 0; y < 100; y++) {
      var val = Math.abs(noise.simplex2(Math.floor(x / config.resolution), Math.floor(y / config.resolution)));
...
var drawPoly = function drawPoly() {
  ...
  for (var i = 0; i < config.noise.length; i++) {
  ...
  var outline = hull(points, config.concavity);

  if (config.rectilinear) {
    outline = outline.reduce(function (acc, curr, idx, src) {
      acc.push(curr);
  ...
  draw.polyline(outline).fill('none').stroke({
    color: '#000',
    width: 2,
    linecap: 'round',
    linejoin: 'round'
...
},{"@svgdotjs/svg.js":"node_modules/@svgdotjs/svg.js/dist/svg.esm.js","hull.js":"node_modules/hull.js/src/hull.js","noisejs":"node_modules/noisejs/index.js"}],"../../.nvm/versions/node/v8.11.2/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../.nvm/versions/node/v8.11.2/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
//# sourceMappingURL=/random-polygon.e31bb0bc.js.map